...
public class EventsTabs extends AppCompatActivity implements TabLayout.OnTabSelectedListener,ViewPager.OnPageChangeListener {
    ...
    private void addPages()
    {
        ...
        pagerAdapter.addFragment(new FutureEvents());
        pagerAdapter.addFragment(new PastEvents());
        pagerAdapter.addFragment(new PendingEvents());
